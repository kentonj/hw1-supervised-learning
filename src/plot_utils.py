...
def plot_confusion_matrix(cm, model_id, classes, normalize=False, title='Confusion matrix', cmap=plt.cm.Blues, figure_action='show', figure_path='figures/cm'):
    '''
    ...
    if figure_action == 'show':
        ...
        plt.savefig(figure_path+'/'+model_id+'.png')
